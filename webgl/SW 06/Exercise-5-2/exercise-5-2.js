...
function setUpAttributesAndUniforms ()
{
    ...
    mat4.rotate (modelviewMat, modelviewMat, -40.0 * Math.PI / 180.0, [0, 0, 1]);
...
{
    "use strict";
    texturedCube = new TexturedCube (gl);
}
...
{
    "use strict";
    texturedCube.enableTexture (false);
    draw();
}
...
{
    "use strict";
    texturedCube.enableTexture (true);
    draw();
}
